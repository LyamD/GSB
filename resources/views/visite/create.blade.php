                        ...
                        <form method="POST" action="{{ action('VisiteController@store') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="motif" class="form-control @error('motif') is-invalid @enderror"
                                            name="motif" rows="5" required></textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="utilisateurs_id" name="utilisateurs_id">
                                            ...
                                            <option value="{{$prac['id']}}">{{$prac['nom'] . " " . $prac['prenom']}}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="visiteurMedicaux_id"
                                            ...
                                            <option value="{{$vis['id']}}">{{$vis['nom'] . " " . $vis['prenom']}}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row justify-content-center">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="dateMission"
